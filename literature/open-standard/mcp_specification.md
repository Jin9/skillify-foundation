...
Source: https://modelcontextprotocol.io/specification/2025-11-25 (assembled from the official per-section .md pages; each section marked with its source URL)
Accessed: 2026-07-05
Category: open-standard / MCP protocol spec
Provenance: new capture 2026-07-05 (gap fill: no dedicated MCP source existed); sections: index, architecture, base protocol + lifecycle + transports, server tools/prompts/resources, changelog

## Why This Source Matters

The authoritative MCP specification (rev 2025-11-25). Skills increasingly orchestrate MCP tools, and skillify templates reference MCP workflows, so the corpus needs the primary protocol contract: architecture, lifecycle, transports, and the tools/prompts/resources server features. Tier 1 official spec.


---

> Section source: https://modelcontextprotocol.io/specification/2025-11-25/index.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/architecture/index.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/basic/index.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/basic/lifecycle.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/basic/transports.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/server/index.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/server/tools.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/server/prompts.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/server/resources.md
...
> Section source: https://modelcontextprotocol.io/specification/2025-11-25/changelog.md
