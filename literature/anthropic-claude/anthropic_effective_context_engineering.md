...
Accessed: 2026-04-26
Category: anthropic-claude / context engineering
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

Anthropic engineering guidance on context discipline, memory, and attention budgets — the empirical basis for progressive disclosure and lean Tier-2 bodies. Tier 1 official source.
