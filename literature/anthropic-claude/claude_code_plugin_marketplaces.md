...
Accessed: 2026-07-05
Category: anthropic-claude / plugin marketplaces
Provenance: new capture 2026-07-05 (gap fill: marketplace distribution was previously undocumented in the corpus)

## Why This Source Matters

Official Claude Code plugin-marketplace documentation: marketplace.json schema, hosting, trust and installation flows. The distribution/supply-chain surface for Claude-side skills; complements the GitHub gh-skill and skills.sh sources. Tier 1 official source.
