...
Accessed: 2026-09-07
Category: anthropic-claude / effort parameter
...
Official reference for the effort parameter (low through max) and per-message effort changes. Fills a verified corpus gap: before this refresh the corpus had no primary source on reasoning-effort controls, which frontier guidance treats as the primary quality/cost lever. Tier 1.
