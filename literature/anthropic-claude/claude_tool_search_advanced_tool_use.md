...
Accessed: 2026-09-07
Category: anthropic-claude / tool search / deferred tools
...
Official reference for the tool search tool and deferred tool loading (defer_loading), the platform-level analogue of progressive disclosure for tool schemas. Fills a verified corpus gap: the feature was previously known only through internal synthesis. Tier 1.
