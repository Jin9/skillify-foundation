...
Accessed: 2026-04-26
Category: anthropic-claude / agent design patterns
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

Anthropic's canonical agent-design patterns (prompt chaining, routing, orchestrator-workers, evaluator-optimizer) that skill workflows encode. Grounds skillify's workflow-patterns reference. Tier 1 official source.
