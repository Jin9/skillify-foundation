...
Accessed: 2026-09-07
Category: anthropic-claude / adaptive and preserved thinking
...
Official reference for adaptive thinking, interleaved thinking, thinking display modes, progress updates between tool calls, and preserved thinking (model- and conversation-bound thinking blocks). Fills the corpus's thinking-budget gap and explains why 'show your reasoning' instructions are now harmful. Tier 1.
