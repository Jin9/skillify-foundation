...
Accessed: 2026-07-05
Category: anthropic-claude / agent skills spec
Provenance: re-captured 2026-07-05 as served markdown (previous capture was a raw HTML dump, Accessed 2026-05-14)

## Why This Source Matters

The authoritative Anthropic specification of Agent Skills: SKILL.md as the instruction layer, frontmatter contract, progressive disclosure of bundled files, and where skills load across Claude surfaces. Tier 1 official source of truth for Claude-side syntax and behavior.
