...
Accessed: 2026-07-05
Category: anthropic-claude / plugins
Provenance: new capture 2026-07-05 (gap fill: plugin distribution surface was previously undocumented in the corpus)

## Why This Source Matters

Official Claude Code plugin documentation: how skills, commands, agents, hooks, and MCP servers bundle into installable plugins. Fills a verified corpus gap — skillify-built skills are distributed through this mechanism. Tier 1 official source.
