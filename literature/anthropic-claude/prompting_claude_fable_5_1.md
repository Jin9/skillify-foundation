...
Accessed: 2026-09-07
Category: anthropic-claude / frontier prompting (Fable 5.1)
Provenance: new capture 2026-09-07 (frontier-model cohort: Claude Fable 5.1 / GPT-6 Astra generation); served markdown, YAML front matter removed

## Why This Source Matters

Anthropic's official prompting guide for Claude Fable 5.1: effort levels, user-facing progress updates, batching independent tool calls, append-only history, writing density and formatting, finishing the whole task, scope and test discipline, subagents, and the explicit warning that prompts and skills written for prior models are often too prescriptive. Tier 1 primary source for skillify's de-prescription and operating-contract rules.
