...
Accessed: 2026-09-07
Category: anthropic-claude / model facts (Fable 5.1)
...
Model-level facts for Claude Fable 5.1 and Claude Mythos 5.1: 1M context, 128K output, always-on adaptive thinking controlled by effort, per-message effort, turn-scoped system messages, progress updates between tool calls, preserved thinking, pricing and availability. Tier 1; grounds the corpus's capability-tier and effort vocabulary.
