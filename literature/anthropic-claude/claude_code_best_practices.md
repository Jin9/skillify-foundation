...
Accessed: 2026-04-26
Category: anthropic-claude / coding-agent workflow
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

Official Claude Code best practices for real codebase workflows: context setup, planning, testing loops, and iteration. Grounds how skills should structure multi-step coding workflows. Tier 1 official source.
...
UI changes can be verified using the Claude in Chrome extension. It opens new tabs in your browser, tests the UI, and iterates until the code works. Your verification can also be a test suite, a linter, or a Bash command that checks output. Invest in making your verification rock-solid.
