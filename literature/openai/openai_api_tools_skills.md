...
Accessed: 2026-04-26
Category: openai / skills in the API
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

OpenAI API guide describing skills as versioned bundles (SKILL.md frontmatter + instructions) attachable to agent instances — aligns the API surface with the open Agent Skills standard. Tier 1 official source.
