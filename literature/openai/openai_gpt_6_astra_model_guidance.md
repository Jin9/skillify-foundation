...
Accessed: 2026-09-07
Category: openai / GPT-6 Astra model guidance
...
OpenAI's official model guidance for GPT-6 Astra: migration quickstart (removed sampling params, reasoning-effort mapping), and prompting best practices for initiative and follow-through, instruction following, sensitivity to skills and AGENTS.md, personality and writing style, subagent delegation, and testing scope. Tier 1 primary source for the instruction-priority and autonomy rules.
