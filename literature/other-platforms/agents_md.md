...
Accessed: 2026-04-26
Category: other-platforms / AGENTS.md open format
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

The AGENTS.md open format — the universal portable baseline for repo-level agent instructions, first-class in Cursor, Cline, OpenCode, and Windsurf. Companion standard to SKILL.md. Tier 2 open standard.
...
+ 421](https://github.com/openai/codex/blob/-/AGENTS.md)[### apache/airflow

Platform to programmatically author, schedule, and monitor workflows.

Python

+ 4292](https://github.com/apache/airflow/blob/-/AGENTS.md)[### temporalio/sdk-java

Java SDK for Temporal, workflow orchestration defined in code.

Java

+ 127](https://github.com/temporalio/sdk-java/blob/-/AGENTS.md)[### PlutoLang/Pluto
