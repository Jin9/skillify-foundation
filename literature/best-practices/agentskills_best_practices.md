...
Accessed: 2026-07-05
Category: best-practices / open-standard authoring
Provenance: re-captured 2026-07-05 as served markdown (previous capture was a raw HTML dump, Accessed 2026-05-14)

## Why This Source Matters

The open-standard authoring guide: lean SKILL.md under ~500 lines / 5,000 tokens, references for depth, trigger design. As the AgentSkills.io standard matured into the cross-platform baseline, this became a primary portability source. Tier 2 open standard.
