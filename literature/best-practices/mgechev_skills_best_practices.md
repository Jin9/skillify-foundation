# GitHub - mgechev/skills-best-practices: Write professional-grade skills for agents, validate them using LLMs, and maintain a lean context window. · GitHub

Source: https://github.com/mgechev/skills-best-practices
Accessed: 2026-04-26
Category: best-practices / professional-grade skills
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

Widely-cited community guide on professional-grade skills: validation discipline, lean context windows, and maintainable structure. Tier 4 community guide with strong practitioner weight.


mgechev   / ** skills-best-practices ** Public
...
**To evaluate if your skills do well and prevent regressions, check out [skillgrade](([https://github.com/mgechev/skillgrade](https://github.com/mgechev/skillgrade)).**
