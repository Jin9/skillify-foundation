...
Accessed: 2026-04-26
Category: codex-copilot / codex workflow
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

Official Codex workflow practices: planning first, reusable guidance, validation loops, MCP, and automation. Context for how skills slot into the larger Codex loop. Tier 1 official source.
