...
Accessed: 2026-04-26
Category: codex-copilot / AGENTS.md guide
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

OpenAI's AGENTS.md guide: repo-level persistent rules versus SKILL.md reusable workflows, and instruction layering. Grounds the repo-policy boundary skillify enforces. Tier 1 official source.
