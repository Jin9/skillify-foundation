...
Accessed: 2026-04-26
Category: codex-copilot / codex skills
Provenance: normalized 2026-07-05 from raw HTML capture; original Accessed date preserved

## Why This Source Matters

OpenAI's official Codex Agent Skills documentation: focused skills, clear inputs/outputs, instructions-over-scripts preference, and trigger testing. Tier 1 official source for the Codex side.
