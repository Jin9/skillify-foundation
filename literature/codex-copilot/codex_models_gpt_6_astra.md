...
Accessed: 2026-09-07
Category: codex-copilot / Codex models (GPT-6 Astra)
...
OpenAI's Codex models page as of the GPT-6 Astra release: model slugs, reasoning-effort options, when to choose Astra versus Sol/Terra/Luna, and Astra's experimental context management that keeps notes across context windows. Tier 1 for the Codex host.
