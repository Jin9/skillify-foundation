# GPT-6 Astra Arrives: Configuring OpenAI’s Most Capable Model in Codex CLI | Codex Knowledge Base

Source: https://codex.danielvaughan.com/2026/09/03/gpt-6-astra-codex-cli-configuration-context-notes-safety/
Accessed: 2026-09-07
Category: codex-copilot / Codex CLI GPT-6 Astra configuration (community)
...
Community knowledge-base note on configuring GPT-6 Astra in Codex CLI: config.toml keys, reasoning effort, context notes, and safety thresholds, written the day of release. Tier 2 secondary source for Codex-host mechanics; verify claims against the official Codex docs.
...
OpenAI / 9to5Mac — “OpenAI releasing major upgrade to ChatGPT and Codex with GPT-6 Astra, details here” — 9to5Mac, 3 September 2026. [https://9to5mac.com/2026/09/03/openai-releasing-major-upgrade-to-chatgpt-and-codex-with-gpt-6-astra-details-here/](https://9to5mac.com/2026/09/03/openai-releasing-major-upgrade-to-chatgpt-and-codex-with-gpt-6-astra-details-here/) ↩ ↩2 ↩3 ↩4

-

openai/codex — Releases — v0.153.1, 3 September 2026. [https://github.com/openai/codex/releases](https://github.com/openai/codex/releases) ↩ ↩2

-

OpenAI — GPT-6 Astra System Card — Deployment Safety Hub. [https://deploymentsafety.openai.com/gpt-6-astra](https://deploymentsafety.openai.com/gpt-6-astra) ↩ ↩2 ↩3 ↩4 ↩5 ↩6 ↩7

-

OpenAI — GPT-6 Astra model documentation — OpenAI API Reference. [https://developers.openai.com/api/docs/models/gpt-6-astra](https://developers.openai.com/api/docs/models/gpt-6-astra) ↩ ↩2 ↩3 ↩4

-

openai/codex — Releases — v0.153.0, 3 September 2026. [https://github.com/openai/codex/releases](https://github.com/openai/codex/releases) ↩

-

kingy.ai — “GPT-6 Astra Access: Plans, API, Pricing, Daybreak” — September 2026. [https://kingy.ai/news/gpt-6-astra-access-chatgpt-api-daybreak/](https://kingy.ai/news/gpt-6-astra-access-chatgpt-api-daybreak/) ↩
