...
```bash
ls -la ~/.gemini/skills/creating-skill-templates/
...
```markdown
- When the user mentions 'skill template' or 'create a skill', activate the 'creating-skill-templates' skill to guide SKILL.md authoring using best practices.
```
