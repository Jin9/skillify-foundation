#!/usr/bin/env bash
# install.sh — Install creating-skill-templates to all supported AI platforms
# Run from: skill-template-creator/platforms/
set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
SKILL_DIR="$(cd "$SCRIPT_DIR/.." && pwd)"
SKILL_NAME="creating-skill-templates"
...
echo "  a SKILL.md or agent skill, activate the 'creating-skill-templates' skill"
