---
name: clean-go-service
description: >
  Incrementally refactor messy Go microservices toward clean DDD and CQRS
  architecture while preserving behavior. Use when asked to clean up, refactor,
  restructure, or improve Go service code without changing external behavior.
  Do not use for bug fixes, feature additions, or broad rewrites that mix
  behavior change with refactoring.
